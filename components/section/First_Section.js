            ...
            <div className='bg-gray-100 lg:min-h-screen flex flex-col lg:flex-row items-center lg:px-12 lg:py-16 xl:py-20 xl:px-24 py-20 px-6'>
                ...
                <div className='flex-1 flex justify-start items-center mb-10 lg:mb-0'>
                    <div className='md:max-w-2xl lg:max-w-[23rem] xl:max-w-[35rem] text-center lg:text-left lg:pr-12'>
                        <h1 data-aos="fade-up" className='text-3xl md:text-4xl lg:text-3xl xl:text-5xl font-bold text-[#2a5b84] pb-4 uppercase leading-8 md:leading-10 xl:leading-[3.5rem] lg:leading-9'>
                        ...
                        <div className='flex justify-center lg:justify-start'>
                            <Link href='#booking'>
                                <p data-aos="fade-up" className='rounded-full px-12 py-4 bg-yellow-500 text-sky-900 hover:text-white font-normal mt-4 xl:mt-2 xl:px-12 xl:py-4 hover:bg-sky-900 lg:text-lg text-sm'>
                                    BOOK A CALL
                                </p>
                            </Link>
                        </div>
